...
### This repository contains the code for my BSc-Thesis in Computer Graphics regarding lenticular lenses and surfaces and ways to understand them using notions like texture mapping and blending, [BRDFs](https://en.wikipedia.org/wiki/Bidirectional_reflectance_distribution_function) and [BSDFs](https://en.wikipedia.org/wiki/Bidirectional_scattering_distribution_function), ambient occlusion and various others. This research aims to shed some light to the behavior of said surfaces by carefully breaking it down to modular parts that are directly connected to CG theory. To carry out the experiments I used Unity's [ShaderLab](https://docs.unity3d.com/Manual/SL-Reference.html). You can find the full paper in 🇺🇲 [here](https://www.icloud.com/iclouddrive/0f3qZ4K9DeCqb8NVfGMX8Jhxw#Lenticular_Lenses_and_Surfaces) and the report in 🇬🇷 [here](https://www.icloud.com/iclouddrive/0d0wib-fx80_OXtX6WeglXdJw).    

##### WARNING(❗): The paper is by no means in any way publishable and the *paper* style I chose was meant to familiarize me with the 2-column academic style of writing and nothing more than that (you will see for yourself 😆). So essentially it's a dummy paper that you can view as a report that describes the core ideas of the thesis and not a serious attempt at academic writing. Thank you for understanding.
...
![Grated Normal](assets/blendedNormal.png)
![Cubemap](assets/spherical.png)
...
![Zoom](assets/zoom.png "Our grated surface zoomed in; we can clearly see the invividual micro-effects that combined give us the general grating effect")
...
![Left Lenticule](assets/leftLenticule.png "Left side of the lenticule")
...
![Max Zoom](assets/maxZoom.png "Zooming in even further")
